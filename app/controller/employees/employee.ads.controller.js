...
class AdController {
  ...
  async createAd(req, res) {
    try {
      ...
      await ad.save();
      res.redirect(`/employees/${type.toLowerCase()}-ads`);
    } catch (error) {
      console.error("Error creating ad:", error);
      res.redirect(`/employees/${req.body.type.toLowerCase()}-ads?error=Error creating ad`);
    }
  }
  ...
  async update(req, res) {
    try {
      ...
      res.redirect(`/employees/${updatedAd.type.toLowerCase()}-ads`);
    } catch (err) {
  ...
  async delete(req, res) {
    try {
      ...
      res.redirect(`/employees/${ad.type.toLowerCase()}-ads`);
    } catch (err) {
      console.error("Error deleting ad:", err);
      res.redirect(`/employees/${req.params.type.toLowerCase()}-ads?error=Error deleting ad`);
    }
  }
}
